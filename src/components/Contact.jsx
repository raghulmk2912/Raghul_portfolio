        ...
        <div className='grid lg:grid-cols-2 gap-10'>
            ...
            <div className='flex flex-col justify-center space-y-8'>
                <div>
                    ...
                    <p className='text-gray-300 my-5'>Drop me a line! I’m always excited to meet new people, share insights, and build meaningful connections.</p>
                    <h3 className='text-2xl font-semibold text-gray-300'>Email</h3>
                    <p className='text-gray-600 mt-2'>
                        <a href="#" className='text-blue-500 hover:underline'>raghulraghul2912@gmail.com</a>
                    </p>
                </div>
                <div>
                    <h3 className='text-2xl font-semibold text-gray-300'>Phone</h3>
                    <p className='text-gray-600 mt-2'>
                        <a href="#" className='text-blue-500 hover:underline'>+91 6383896364</a>
                    </p>
                </div>
                <div>
