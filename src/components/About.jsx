      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='flex flex-col md:flex-row gap-20 items-center'>
            ...
            <div className='p-5 md:p-10 bg-gray-950 rounded-md shadow-[0px_0px_20px_10px_rgba(0,0,0,0.3)] shadow-blue-500'>
                <p className='text-lg leading-7 mb-6'>Hi! I'm Raghul.M.K, a passionate Full-Stack Developer with expertise in the MERN stack, JAVA, and SEO. With a strong foundation in modern web development and an eye for detail, I create elegant, user-friendly web solutions tailored to meet client needs.</p>
                <p className='text-lg leading-7 mb-6'>My journey into tech began from a IT background, and I've embraced every challenge to hone my skills in development, problem-solving, and teamwork. I’m always eager to learn and explore new technologies to deliver cutting-edge web experiences.</p>
