    ...
    <section className='h-max md:h-screen bg-gradient-to-l bg-gray-950 text-white flex flex-col justify-center items-center relative z-10 pb-10'>
      ...
      <div className='max-w-7xl mt-24 mx-auto items-center flex flex-col md:flex-row gap-16 md:gap-40 justify-between'>
        <div className='md:space-y-6 px-4'>
            ...
            className='md:text-6xl text-4xl font-bold mb-4'>Hi👋, I'm <p className='text-blue-400'>Raghul M K</p></motion.h1>
            <motion.p 
            initial={{opacity:0, x:-100}}
            whileInView={{opacity:1, x:0}}
            ...
            className='lg:w-[600px] mb-4 md:mb-0 text-sm text-gray-300'>I am a fresher skilled in MERN stack development, with knowledge of Java and Spring Boot. I am eager to learn and adapt to new technologies, constantly enhancing my skills. With a strong foundation in web development and a passion for problem-solving, I am ready to contribute and grow professionally.</motion.p>
            <motion.button 
            initial={{opacity:0, x:-100}}
            whileInView={{opacity:1, x:0}}
            transition={{duration:1.4, delay:0.5}}
